...
export const STATIC_ROUTES: StaticRoute[] = [
  ...
  },
  {
    ...
    label: 'Content QA',
    path: '/content',
    description: 'Review AI-generated and user-submitted content quality.',
    group: 'Plan',
    keywords: ['content', 'qa', 'quality', 'moderation'],
  },
  {
    id: 'nav:inventory',
    label: 'User stories',
    path: '/inventory',
    description: 'User-story inventory and live crawl proposals.',
    group: 'Plan',
    keywords: ['stories', 'inventory', 'discovery', 'crawl'],
  },
  {
    id: 'nav:qa-coverage',
    label: 'QA Coverage',
    path: '/qa-coverage',
    description: 'Scheduled Playwright user-story tests.',
    group: 'Check',
    keywords: ['qa', 'playwright', 'stories', 'coverage', 'test'],
  },
  {
    id: 'nav:fullstack-audit',
    label: 'Full-Stack Audit',
    path: '/fullstack-audit',
    description: 'End-to-end audit across frontend, API, and database.',
    group: 'Check',
    keywords: ['audit', 'fullstack', 'fe', 'be', 'schema'],
  },
  {
    id: 'nav:lessons',
    label: 'Lessons',
    path: '/lessons',
    description: 'Patterns learned from past bugs and fixes.',
    group: 'Check',
    keywords: ['lessons', 'learned', 'patterns', 'pdca'],
  },
  {
    id: 'nav:drift',
    label: 'Drift',
    path: '/drift',
    description: 'Schema and backend drift detection.',
    group: 'Check',
    keywords: ['drift', 'schema', 'backend', 'migration'],
  },
  {
    id: 'nav:anomalies',
    label: 'Anomalies',
    path: '/anomalies',
    description: 'Statistical anomaly detection on metrics.',
    group: 'Check',
    keywords: ['anomalies', 'spike', 'outlier', 'metrics'],
  },
  {
    id: 'nav:releases',
    label: 'Releases',
    path: '/releases',
    description: 'Shipped releases with reporter credit.',
    group: 'Check',
    keywords: ['releases', 'changelog', 'ship', 'deploy'],
  },
  {
    id: 'nav:iterate',
    label: 'Iterate',
    path: '/iterate',
    description: 'PDCA producer–critic improvement loop.',
    group: 'Act',
    keywords: ['iterate', 'pdca', 'improve', 'loop'],
  },
  {
    id: 'nav:rewards',
    label: 'Rewards',
    path: '/rewards',
    description: 'Tester rewards and redemption catalog.',
    group: 'Workspace',
    keywords: ['rewards', 'tester', 'bounty', 'wallet'],
  },
  {
    id: 'nav:cost',
    label: 'LLM Cost',
    path: '/cost',
    description: 'Token usage and LLM spend by stage.',
    group: 'Workspace',
    keywords: ['cost', 'llm', 'tokens', 'billing', 'usage'],
  },
  {
    id: 'nav:feedback',
    label: 'My feedback',
    path: '/feedback',
    description: 'Feedback you submitted to Mushi.',
    group: 'Start',
    keywords: ['feedback', 'feature', 'bug', 'request'],
  },
  {
    id: 'nav:feature-board',
    label: 'Feature board',
    path: '/feature-board',
    description: 'Community feature requests and votes.',
    group: 'Start',
    keywords: ['features', 'roadmap', 'votes', 'board'],
  },
]
