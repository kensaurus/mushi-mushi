      ...
      {items.map(({ label, bg }) => (
        <Tooltip key={label} content={label} side="top">
          <button
            ...
            role="listitem"
            aria-label={label}
            className="inline-flex h-7 w-7 items-center justify-center rounded-sm motion-safe:transition-opacity hover:bg-surface-overlay/60 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand/60"
          >
