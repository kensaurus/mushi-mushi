...
function StepNode({ data }: NodeProps<Node<StepNodeData>>) {
  ...
  return (
    <div
      ...
      className={`relative flex flex-col items-center justify-center gap-0.5 rounded-lg px-1.5 py-1.5 text-center ${ring} ${bg} h-[78px] cursor-pointer transition-all select-none focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-focus focus-visible:ring-offset-2 focus-visible:ring-offset-surface-raised ${
