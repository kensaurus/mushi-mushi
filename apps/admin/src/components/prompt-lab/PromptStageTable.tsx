                  ...
                  <tr key={p.id} className="border-t border-edge-subtle">
                    ...
                    <td className="px-2 py-1.5">
                      {p.is_active ? (
                        ...
                        <Badge className="bg-info-muted/50 text-info-foreground border border-info/25">Candidate</Badge>
                      ) : (
                      ...
                      {p.auto_generated && (
                        <Badge
                          className="ml-1 bg-brand/12 text-brand border border-brand/28"
