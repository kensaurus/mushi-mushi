          ...
          {formKind === 'W8BEN-E' && (
            <div>
              ...
              <select
                ...
                className="w-full rounded-md border border-edge bg-surface-root px-3 py-2 text-xs focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand/40"
              >
