    ...
    <div className="mx-auto max-w-2xl space-y-6">
      ...
      <div className={`${TESTER_PANEL} space-y-4 p-5`}>
        ...
        <label className="flex cursor-pointer items-start gap-2 text-xs text-fg-secondary">
          ...
          <span>
            I agree to the{' '}
            <a href="https://kensaur.us/mushi-mushi/docs/legal/terms" target="_blank" rel="noreferrer" className="text-accent-foreground hover:text-accent underline underline-offset-2 motion-safe:transition-opacity">
      ...
      <div className="flex flex-wrap items-center justify-center gap-x-4 gap-y-2 text-xs text-fg-muted sm:justify-start">
        ...
        <a
          ...
          target="_blank"
          rel="noreferrer"
          className="font-medium text-accent-foreground hover:text-accent underline underline-offset-2 motion-safe:transition-opacity"
        >
          Browse marketplace ↗
        </a>
