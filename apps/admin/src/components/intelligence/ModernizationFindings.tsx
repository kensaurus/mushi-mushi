  ...
  return (
    <Card className="overflow-hidden p-0">
      ...
      <div className="border-t border-edge-subtle bg-surface-raised/30 px-3 py-2 text-2xs text-fg-faint">
        Dispatched fixes track on <Link to="/fixes" className="text-accent-foreground hover:text-accent underline underline-offset-2 motion-safe:transition-opacity">Fixes</Link>.
      </div>
    </Card>
  )
}
