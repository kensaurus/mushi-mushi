...
/**
 * Helper export for cases where a caller wants the raw receipt shape (e.g.
 * to render a compact strip elsewhere). `StageStamp` is re-exported from
 * `lib/pdcaStamp` so all consumers share one type.
 */
export type { StageReceipt }
export type { StageStamp } from '../../lib/pdcaStamp'
