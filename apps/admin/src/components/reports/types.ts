...
export interface ReportRow {
  ...
  summary: string | null
  /** Friendly, plain-language headline generated by Stage 2 (suitable for
   *  non-engineers). Null for reports classified before this field was added;
   *  UI falls back to summary. */
  title?: string | null
  /** Coarse product-area label from Stage 2 (e.g. "Checkout", "Auth"). */
