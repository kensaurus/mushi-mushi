        ...
        >
          <div className="mb-4 flex items-start justify-between gap-4">
            <div className="min-w-0">
              <p className="flex items-center gap-2 font-mono text-[10px] uppercase tracking-[0.22em] text-[var(--mushi-vermillion)]">
                <span className="grid h-5 w-5 place-items-center rounded-sm bg-[var(--mushi-vermillion)] font-mono text-[9px] text-white shadow-[inset_0_-2px_0_rgba(0,0,0,0.25)]">
            ...
            <button
              ...
              type="button"
              onClick={onClose}
              className="shrink-0 rounded-sm border border-[var(--mushi-rule)] bg-white/40 px-3 py-2 font-mono text-[10px] uppercase tracking-[0.18em] text-[var(--mushi-ink-muted)] transition hover:border-[var(--mushi-vermillion)] hover:text-[var(--mushi-vermillion)]"
            >
              Close ✕
            </button>
          </div>
                ...
                <ul className="mt-4 space-y-2">
                  {stage.bullets.map((bullet, i) => (
                    ...
                    >
                      <span
                        aria-hidden="true"
                        className="mt-0.5 grid h-5 w-5 shrink-0 place-items-center rounded-sm border border-[var(--mushi-vermillion)]/40 bg-[var(--mushi-vermillion-wash)] font-mono text-[9px] font-semibold text-[var(--mushi-vermillion)]"
                      >
                        {i + 1}
                      </span>
                      <span>{bullet}</span>
