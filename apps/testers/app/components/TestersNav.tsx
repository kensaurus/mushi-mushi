  ...
  return (
    <nav className="testers-nav sticky top-0 z-40">
      <div className="mx-auto flex h-14 max-w-5xl items-center justify-between gap-4 px-4">
        <Link href="/" className="text-lg font-bold text-[var(--mushi-ink)]">
          <span className="testers-brand-mark">mushi</span>mushi
          <span className="testers-badge ml-2">Bounties</span>
        </Link>
        <div className="hidden items-center gap-4 text-sm sm:flex">
          <Link href="/apps/" className="testers-muted hover:text-[var(--mushi-ink)] motion-safe:transition-colors">
            Apps
          </Link>
          <Link href="/how-it-works/" className="testers-muted hover:text-[var(--mushi-ink)] motion-safe:transition-colors">
            How it works
          </Link>
          <Link href="/leaderboard/" className="testers-muted hover:text-[var(--mushi-ink)] motion-safe:transition-colors">
            Leaderboard
          </Link>
        </div>
        <a
