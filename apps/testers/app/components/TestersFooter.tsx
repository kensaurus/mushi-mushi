  ...
  return (
    <footer className="border-t border-[var(--mushi-rule)] py-8 text-center text-sm testers-faint">
      <p>
        ...
        <Link href={`${BASE}/apps/`} className="hover:text-[var(--mushi-ink-muted)] motion-safe:transition-colors">
          Browse apps
        </Link>
        {' · '}
        <Link href={`${BASE}/how-it-works/`} className="hover:text-[var(--mushi-ink-muted)] motion-safe:transition-colors">
          How it works
        </Link>
        {' · '}
        <Link href={`${BASE}/leaderboard/`} className="hover:text-[var(--mushi-ink-muted)] motion-safe:transition-colors">
          Leaderboard
        </Link>
        {' · '}
