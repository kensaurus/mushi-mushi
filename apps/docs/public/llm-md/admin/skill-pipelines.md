...
Source: https://kensaur.us/mushi-mushi/docs/admin/skill-pipelines
...
Share a pre-loaded review link with any team member:

```
https://kensaur.us/mushi-mushi/admin/reports/<report-id>?skill=workflow-fix-and-ship
```
