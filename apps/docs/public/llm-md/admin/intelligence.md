...
Source: https://kensaur.us/mushi-mushi/docs/admin/intelligence
...
is not archived.
  ...
  Regeneration is rate-limited to **3 times per week per project** on Indie plans
...
- [Self-hosting → Observability (Langfuse + Sentry)](/self-hosting/observability) — trace the LLM calls that generate the narrative.
