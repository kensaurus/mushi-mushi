...
paste-ready fix you can hand to your editor's agent via MCP.
  ...
  **Three ways to run Mushi with Sentry:**
  1. **Route errors in (recommended)** — point a Sentry issue-alert webhook at
     `/v1/webhooks/sentry?projectId=<your-project>` and Sentry errors land
