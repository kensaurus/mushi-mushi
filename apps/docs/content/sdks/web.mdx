...
Catch what users felt — screenshots, console logs, and a shake-to-report widget —
without bolting on another dashboard. The browser SDK runs in a Shadow DOM so your CSS
