...
The JS packages are MIT-licensed; the server packages (`@mushi-mushi/server`, `@mushi-mushi/agents`, `@mushi-mushi/admin`) are AGPLv3 — true OSI open source, copyleft applies to SaaS redistributions.
