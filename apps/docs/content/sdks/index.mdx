...
| Package | Version |
| --- | --- |
| @mushi-mushi/core, @mushi-mushi/web | 1.14.x |
| @mushi-mushi/react | 1.10.x |
| @mushi-mushi/react-native | 0.16.x |
| @mushi-mushi/cli | 0.17.x |
| @mushi-mushi/mcp | 0.14.x |
| @mushi-mushi/capacitor | 0.8.x |
| @mushi-mushi/node | 0.6.x |
| @mushi-mushi/angular, @mushi-mushi/vue, @mushi-mushi/svelte | 0.9.x |
...
The JS packages are MIT-licensed; the server packages (`@mushi-mushi/server`, `@mushi-mushi/agents`, `@mushi-mushi/admin`) are BSL — free for self-hosting, commercial license required for hosted-as-a-service redistribution.
