...
Full config options are documented in [`MushiCapacitorPluginConfig`](https://github.com/kensaurus/mushi-mushi/blob/main/packages/capacitor/src/definitions.ts).
