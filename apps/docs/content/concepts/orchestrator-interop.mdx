...
flowchart TB
  subgraph Inbound["Inbound to Mushi"]
    MCP["MCP — both stdio AND Streamable HTTP<br/>72 tools / 8 resources / 4 prompts"]
...
The full tool catalog (72 tools, 8 resources, 4 prompts) lives in
...
| --------------------------------------------------- | -------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Cursor / Cursor Agents**                          | stdio MCP                        | Already supported, 72 tools instantly. Add `@mushi-mushi/mcp` to `mcpServers` in agent config                                                                                                                   |
