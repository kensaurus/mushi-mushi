...
For a shorter version see [The evolution loop](/concepts/evolution-loop). For the manifesto see the [EVOLUTION-LOOP.md](https://github.com/kensaurus/mushi-mushi/blob/main/docs/EVOLUTION-LOOP.md) doc.
