...
> a day manually testing every screen, you queue a PDCA run — point it at your live
...
- [Fix orchestrator](/admin/fixes) — dispatch individual fixes outside the PDCA loop
