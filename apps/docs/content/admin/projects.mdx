...
1. Click **Create** at the top, enter a project name.
2. Select scope **SDK ingest** → click **Generate API key** → copy immediately.
3. Paste the key into your app using the SDK snippet configurator (select your framework).
4. Click **Send test report** — a `pass` status chip confirms the pipeline is live.
5. Open [Reports](/admin/reports) — the test report appears within 10 seconds.
