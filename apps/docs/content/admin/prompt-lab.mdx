...
| **Stage 2 (classify)** | Category / severity / component — edit if triage labels are wrong |
...
the normal Reports flow — each triage action generates a labelled example automatically.
