...
[![Add to Cursor](https://img.shields.io/badge/Add%20to-Cursor-0098FF)](https://docs.mushimushi.dev/connect)
[![Add to VS Code](https://img.shields.io/badge/Add%20to-VS%20Code-007ACC?logo=visualstudiocode&logoColor=white)](https://docs.mushimushi.dev/connect)
[![Try the demo — no signup](https://img.shields.io/badge/Try%20the%20demo-no%20signup-E34234)](https://docs.mushimushi.dev/connect)

<Callout type="info">
  **Fastest path — one click.** Open the [Connect page](https://docs.mushimushi.dev/connect)
