...
Mushi and Cursor close the development loop together: users report bugs,
Mushi classifies them and builds fix briefs, Cursor agents read the briefs
and write the patches, and the judge scores each fix so the lesson library
gets smarter.
