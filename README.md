...
<sub>Repo at a glance (run `pnpm docs-stats`): ~350K TS lines · 1,686 source files · 44 workspace / 36 npm packages · 51 edge functions · 322 SQL migrations · 19 pipeline agents. Full tour: [`docs/SCREENSHOTS.md`](./docs/SCREENSHOTS.md).</sub>
