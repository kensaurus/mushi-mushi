...
<sub>Repo at a glance (run `pnpm docs-stats`): ~363K TS lines · 1,754 source files · 44 workspace / 36 npm packages · 55 edge functions · 328 SQL migrations · 19 pipeline agents. Full tour: [`docs/SCREENSHOTS.md`](./docs/SCREENSHOTS.md).</sub>
