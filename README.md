...
<a href="https://kensaur.us/mushi-mushi/" title="Open the live admin demo — animated guided tour">
  <img src="./docs/screenshots/tour.gif" alt="Animated 8-page guided tour through the admin console — Dashboard PDCA cockpit (4-stage React Flow canvas with marching-ants on the bottleneck), Reports triage queue with severity stripes, Fixes auto-fix pipeline with per-attempt PDCA cards, Repo live branch graph with Supabase Realtime event stream, Judge scores with Decide/Act/Verify hero, Health LLM cost-per-call breakdown, Knowledge graph Sankey storyboard, Integrations health-checked Sentry/Langfuse/GitHub probes" width="100%" />
</a>

<sub>↑ animated 8-room guided tour · static deep-dive hero below · click to open the live admin</sub>
