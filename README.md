...
<sub>Repo at a glance (run `pnpm docs-stats`): ~406K TS lines · 1,880 source files · 44 workspace / 36 npm packages · 59 edge functions · 370 SQL migrations · 19 pipeline agents. Full tour: [`docs/SCREENSHOTS.md`](./docs/SCREENSHOTS.md).</sub>
