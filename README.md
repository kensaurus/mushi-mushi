...
<sub>Repo at a glance (run `pnpm docs-stats`): ~358K TS lines · 1,731 source files · 44 workspace / 36 npm packages · 54 edge functions · 324 SQL migrations · 19 pipeline agents. Full tour: [`docs/SCREENSHOTS.md`](./docs/SCREENSHOTS.md).</sub>
