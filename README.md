...
<sub>Repo at a glance (run `pnpm docs-stats`): ~348K TS lines · 1,680 source files · 44 workspace / 36 npm packages · 51 edge functions · 318 SQL migrations · 19 pipeline agents. Full tour: [`docs/SCREENSHOTS.md`](./docs/SCREENSHOTS.md).</sub>
