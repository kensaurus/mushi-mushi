...
<sub>Repo at a glance (run `pnpm docs-stats`): ~407K TS lines · 1,886 source files · 44 workspace / 36 npm packages · 59 edge functions · 374 SQL migrations · 19 pipeline agents. Full tour: [`docs/SCREENSHOTS.md`](./docs/SCREENSHOTS.md).</sub>
