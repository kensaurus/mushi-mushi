...
<sub>Repo at a glance (run `pnpm docs-stats`): ~387K TS lines · 1,814 source files · 44 workspace / 36 npm packages · 58 edge functions · 347 SQL migrations · 19 pipeline agents. Full tour: [`docs/SCREENSHOTS.md`](./docs/SCREENSHOTS.md).</sub>
