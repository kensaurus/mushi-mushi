...
<sub>Repo at a glance (run `pnpm docs-stats`): ~372K TS lines · 1,768 source files · 44 workspace / 36 npm packages · 55 edge functions · 336 SQL migrations · 19 pipeline agents. Full tour: [`docs/SCREENSHOTS.md`](./docs/SCREENSHOTS.md).</sub>
