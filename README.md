...
<sub>Repo at a glance (run `pnpm docs-stats`): ~403K TS lines · 1,863 source files · 44 workspace / 36 npm packages · 59 edge functions · 366 SQL migrations · 19 pipeline agents. Full tour: [`docs/SCREENSHOTS.md`](./docs/SCREENSHOTS.md).</sub>
