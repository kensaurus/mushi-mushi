...
<sub>Repo at a glance (run `pnpm docs-stats`): ~354K TS lines · 1,720 source files · 44 workspace / 36 npm packages · 51 edge functions · 323 SQL migrations · 19 pipeline agents. Full tour: [`docs/SCREENSHOTS.md`](./docs/SCREENSHOTS.md).</sub>
