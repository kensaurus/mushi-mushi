/**
 * Stand-alone Node HTTPS entry point for the Discord plugin. Usage:
 *
 *   MUSHI_PLUGIN_SECRET=... DISCORD_WEBHOOK_URL=... \
...
createServer(async (req, res) => {
  ...
  console.warn(`mushi-plugin-discord listening on :${port}`)
})
