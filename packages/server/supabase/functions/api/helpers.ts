...
// normalizeSdkConfig / coerceSdkConfigUpdate / SdkConfigRow live in a pure,
// dependency-free module so they're unit-testable without a Deno/network
// dependency graph, and so there's exactly one place to change the SDK
// config shape. Do not redefine these here or in any route file.
export { normalizeSdkConfig, coerceSdkConfigUpdate, type SdkConfigRow } from '../_shared/sdk-config.ts';
