 ...
 *          title, hint, and optional action (server-side notifications).
 *
 * SYNC NOTE: Keep identical to apps/admin/src/lib/humanizeFixError.ts.
...
export function humanizeFixError(
  ...
  // re-index a repo whose index was fine (glot.it, 2026-09-23). Mirrors
  // apps/admin/src/lib/humanizeFixError.ts (check:humanize-parity).
