...
const SAMPLE_ENVELOPES: Record<MushiEventName, MushiEventEnvelope> = {
  ...
  'fix.requested': { event: 'fix.requested', deliveryId: 'dev-0006', occurredAt: new Date().toISOString(), projectId: 'dev-project', pluginSlug: 'dev-plugin', data: { report: { id: 'r_dev_001', status: 'classified' }, fix: { id: 'f_dev_001', status: 'requested' } } },
  'fix.proposed': { event: 'fix.proposed', deliveryId: 'dev-0007', occurredAt: new Date().toISOString(), projectId: 'dev-project', pluginSlug: 'dev-plugin', data: { report: { id: 'r_dev_001', status: 'fixing' }, fix: { id: 'f_dev_001', status: 'proposed', branch: 'mushi/fix/r_dev_001', summary: 'null-check on auth callback' } } },
  'fix.applied': { event: 'fix.applied', deliveryId: 'dev-0008', occurredAt: new Date().toISOString(), projectId: 'dev-project', pluginSlug: 'dev-plugin', data: { report: { id: 'r_dev_001', status: 'fixed' }, fix: { id: 'f_dev_001', status: 'applied', branch: 'mushi/fix/r_dev_001', pullRequestUrl: 'https://github.com/example/app/pull/42', summary: 'null-check on auth callback' } } },
  'fix.failed': { event: 'fix.failed', deliveryId: 'dev-0009', occurredAt: new Date().toISOString(), projectId: 'dev-project', pluginSlug: 'dev-plugin', data: { report: { id: 'r_dev_001', status: 'classified' }, fix: { id: 'f_dev_001', status: 'failed', summary: 'validateResult rejected diff: tests still failing' } } },
  'qa_story.failed': { event: 'qa_story.failed', deliveryId: 'dev-0010', occurredAt: new Date().toISOString(), projectId: 'dev-project', pluginSlug: 'dev-plugin', data: { storyId: 'qa_dev_001', title: 'Login flow — happy path', failureReason: 'Expected selector .dashboard not found within 5000ms' } },
  'qa_story.passed': { event: 'qa_story.passed', deliveryId: 'dev-0011', occurredAt: new Date().toISOString(), projectId: 'dev-project', pluginSlug: 'dev-plugin', data: { storyId: 'qa_dev_001', title: 'Login flow — happy path', durationMs: 3200 } },
  'judge.score_recorded': { event: 'judge.score_recorded', deliveryId: 'dev-0012', occurredAt: new Date().toISOString(), projectId: 'dev-project', pluginSlug: 'dev-plugin', data: { report: { id: 'r_dev_001', status: 'classified' }, judge: { score: 0.81, rationale: 'category accurate; severity under-called', promptVersion: 'stage2-v12' } } },
  'sla.breached': { event: 'sla.breached', deliveryId: 'dev-0013', occurredAt: new Date().toISOString(), projectId: 'dev-project', pluginSlug: 'dev-plugin', data: { report: { id: 'r_dev_001', status: 'classified' }, sla: { severity: 'critical', targetSeconds: 900, elapsedSeconds: 1420 } } },
  'reward.points_awarded': { event: 'reward.points_awarded', deliveryId: 'dev-0014', occurredAt: new Date().toISOString(), projectId: 'dev-project', pluginSlug: 'dev-plugin', data: { end_user_id: 'eu_dev_001', points: 50, action: 'report_submitted', tier: 'bronze' } },
  'reward.tier_changed': { event: 'reward.tier_changed', deliveryId: 'dev-0015', occurredAt: new Date().toISOString(), projectId: 'dev-project', pluginSlug: 'dev-plugin', data: { end_user_id: 'eu_dev_001', previous_tier: 'bronze', new_tier: 'silver', total_points: 500 } },
  'reward.payout_requested': { event: 'reward.payout_requested', deliveryId: 'dev-0016', occurredAt: new Date().toISOString(), projectId: 'dev-project', pluginSlug: 'dev-plugin', data: { end_user_id: 'eu_dev_001', amount_usd: 25, payout_id: 'po_dev_001' } },
  'reward.payout_paid': { event: 'reward.payout_paid', deliveryId: 'dev-0017', occurredAt: new Date().toISOString(), projectId: 'dev-project', pluginSlug: 'dev-plugin', data: { end_user_id: 'eu_dev_001', amount_usd: 25, payout_id: 'po_dev_001', paid_at: new Date().toISOString() } },
}
