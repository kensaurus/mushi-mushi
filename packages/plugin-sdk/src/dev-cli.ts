...
const SAMPLE_ENVELOPES: Record<MushiEventName, MushiEventEnvelope> = {
  ...
  'reward.points_awarded': { event: 'reward.points_awarded', deliveryId: 'dev-0011', occurredAt: new Date().toISOString(), projectId: 'dev-project', pluginSlug: 'dev-plugin', data: { end_user_id: 'eu_dev_001', points: 50, action: 'report_submitted', tier: 'bronze' } },
  'reward.tier_changed': { event: 'reward.tier_changed', deliveryId: 'dev-0012', occurredAt: new Date().toISOString(), projectId: 'dev-project', pluginSlug: 'dev-plugin', data: { end_user_id: 'eu_dev_001', previous_tier: 'bronze', new_tier: 'silver', total_points: 500 } },
  'reward.payout_requested': { event: 'reward.payout_requested', deliveryId: 'dev-0013', occurredAt: new Date().toISOString(), projectId: 'dev-project', pluginSlug: 'dev-plugin', data: { end_user_id: 'eu_dev_001', amount_usd: 25, payout_id: 'po_dev_001' } },
  'reward.payout_paid': { event: 'reward.payout_paid', deliveryId: 'dev-0014', occurredAt: new Date().toISOString(), projectId: 'dev-project', pluginSlug: 'dev-plugin', data: { end_user_id: 'eu_dev_001', amount_usd: 25, payout_id: 'po_dev_001', paid_at: new Date().toISOString() } },
}
