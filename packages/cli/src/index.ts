...
interface SkillRow { slug: string; category: string; title: string; description: string; chain_slugs: string[] }
interface PipelineRunRow { id: string; root_skill_slug: string; mode: string; status: string; created_at: string; report_id: string | null; chain_slugs?: string[] }
interface StepRunRow { step_index: number; skill_slug: string; status: string; pr_url: string | null; notes: string | null }
