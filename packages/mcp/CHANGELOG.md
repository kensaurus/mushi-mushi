...
- Updated dependencies [1ea99b4]
  - @mushi-mushi/core@1.27.2
...
- 0c1639b: The stdio MCP server now works with zero env configuration, and the hosted endpoint supports real OAuth login.
...
- 51bc811: Default `MUSHI_API_ENDPOINT` to the hosted Mushi Cloud endpoint when unset,
...
- f3fd7a7: Fix the stdio server never exiting once its client closes stdin. The
