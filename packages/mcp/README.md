...
Full catalog is **71 tools** (stdio / `MUSHI_FEATURES=all`). The hosted HTTP
...
# (see packages/mcp/src/catalog.ts — currently 71 tools / 8 resources / 4 prompts)
```
...
<sub>Monorepo scale (July 2026): 55 edge functions · 330 SQL migrations · 13 outbound plugins · 11 inbound adapters · 19 pipeline agents. Canonical counts: <a href="https://github.com/kensaurus/mushi-mushi/blob/master/docs/stats.md">docs/stats.md</a> · <code>pnpm docs-stats</code></sub>
