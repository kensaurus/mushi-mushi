...
const SAFE_ARGS = {
  ...
  get_report_evidence: { reportId: '__DYNAMIC__' },
  ...
  query_lessons: { diffText: 'smoke test diff' },
  ...
  get_pipeline_run: { runId: '00000000-0000-0000-0000-000000000001' },
  get_map_run_status: { projectId: '__PROJECT__' },
  get_inventory: { projectId: '__PROJECT__' },
  inventory_current: { projectId: '__PROJECT__' },
  diff_inventory: { projectId: '__PROJECT__', fromSha: 'abc1234', toSha: 'def5678' },
  run_nl_query: { question: 'count open reports' },
  get_knowledge_graph: { seed: 'Button', depth: 1 },
  get_graph_neighborhood: { seed: 'Button', depth: 1 },
  get_graph_node: { nodeId: '00000000-0000-0000-0000-000000000001' },
  search_reports: { query: 'smoke' },
  get_similar_bugs: { query: 'settings freeze' },
  suggest_fix: { reportId: '__DYNAMIC__' },
  triage_issue: { reportId: '__DYNAMIC__' },
