...
- b858f5d: Phase 3 SDK capability parity:
...
- 26e038f: SDK polish from the UI/UX audit pass:
...
- Updated dependencies [26e038f]
  - @mushi-mushi/core@1.26.0
...
- 8544e22: Harden the SDK so it can't break or visibly thrash a host app — across web, SSR, and native-WebView (Capacitor/Cordova/React-Native) integrations — and make transport resilient on flaky networks.
...
- 5feac27: # v1.21.1 — Post-release SDK reliability fixes
...
- Updated dependencies [3604d25]
  - @mushi-mushi/core@1.20.0
...
- 654fe87: Harden the web widget and make the cross-app community bootstrap resilient.
...
- 5ab88d1: fix(widget): remove body nudge on all banner early-return paths + destroy()
...
- 5ab88d1: polish(console): PDCA loop microinteractions, loop-back arc, opaque arrows, chart x-axis labels
...
- Updated dependencies [b2089cb]
  - @mushi-mushi/core@1.7.2
...
- 387bcbc: Improve `screenshot` and `element selector` capture UX in the floating
  widget.
