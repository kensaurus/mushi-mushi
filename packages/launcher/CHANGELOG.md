...
- Updated dependencies [76ec932]
  - @mushi-mushi/cli@0.27.0

## 0.8.0

### Minor Changes

- 0c1639b: `npx mushi-mushi` and `npm create mushi-mushi` now share one arg parser and say plainly what they do.
...
- Updated dependencies [3fb91ad]
  - @mushi-mushi/cli@0.26.0
