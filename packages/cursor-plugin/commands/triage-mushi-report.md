...
4. Call `triage_issue { reportId: "<id>", projectId: "<id>", includeLogs: true }` to pull the full triage packet.
5. Present a structured summary:
   ...
   - **Similar bugs**: list descriptions and similarity from `similar_bugs`
