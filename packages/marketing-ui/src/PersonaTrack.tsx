      ...
      {PERSONA_CARDS.map((card) => (
        <li key={card.id}>
          ...
          >
            ...
            <p className="mt-auto font-mono text-[11px] uppercase tracking-[0.18em] text-[var(--mushi-ink)] opacity-60 transition-[transform,opacity] group-hover:opacity-100">
              {card.cta}
            </p>
          </Link>
        </li>
