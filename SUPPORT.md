...
Thanks for using Mushi Mushi. Here's the fastest way to get the help you need.

## Before you ask

1. **Run the wizard.** `npx mushi-mushi` auto-detects your framework and writes the
   right SDK + env vars. Most setup problems disappear here.
2. **Read the [docs](https://kensaur.us/mushi-mushi/docs/).** Setup guides, concepts,
   and the full API reference live there — including the
...
The [bug report template](https://github.com/kensaurus/mushi-mushi/issues/new?template=bug_report.yml)
walks you through each of these.
