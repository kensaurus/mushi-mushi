...
<tr>
  <td width="50%" valign="top">
    <a href="https://kensaur.us/mushi-mushi/admin/mcp"><img src="./screenshots/mcp-dark.png" alt="MCP — Model Context Protocol page with Add to Cursor deeplink, feature-group selector, and 73-tool catalog synced from packages/mcp/src/catalog.ts." /></a>
