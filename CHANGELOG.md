...
- `@mushi-mushi/plugin-jira` → 0.2.3
- `@mushi-mushi/plugin-linear` → 0.2.5
- `@mushi-mushi/plugin-pagerduty` → 0.2.5
- `@mushi-mushi/plugin-sdk` → 0.2.1
- `@mushi-mushi/plugin-sentry` → 0.2.7
- `@mushi-mushi/plugin-slack-app` → 0.2.3
- `@mushi-mushi/plugin-zapier` → 0.2.5
...
- `@mushi-mushi/plugin-bugsnag` → 0.1.2
- `@mushi-mushi/plugin-crashlytics` → 0.1.2
- `@mushi-mushi/plugin-discord` → 0.1.2
- `@mushi-mushi/plugin-github-issues` → 0.1.2
- `@mushi-mushi/plugin-msteams` → 0.1.2
- `@mushi-mushi/plugin-rollbar` → 0.1.2
