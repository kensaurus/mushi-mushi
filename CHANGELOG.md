...
## v0.22.1 — Post-release SDK reliability fixes *(pending release)*
...
- `@mushi-mushi/react-native` → 0.20.0
...
- `@mushi-mushi/inventory-schema` → 0.4.0
...
- `eslint-plugin-mushi-mushi` → 0.3.0
