...
- `@mushi-mushi/mcp-ci` → 0.6.3
- `@mushi-mushi/node` → 0.6.0
- `@mushi-mushi/plugin-cursor-cloud` → 0.6.0
- `@mushi-mushi/plugin-sdk` → 0.6.0
- `create-mushi-mushi` → 0.6.1
- `mushi-mushi` → 0.6.5
...
- `@mushi-mushi/inventory-schema` → 0.4.2
...
- `@mushi-mushi/plugin-linear` → 0.3.1
...
- `eslint-plugin-mushi-mushi` → 0.3.3
...
- `@mushi-mushi/plugin-jira` → 0.2.6
- `@mushi-mushi/plugin-linear` → 0.2.7
- `@mushi-mushi/plugin-pagerduty` → 0.2.8
- `@mushi-mushi/plugin-sdk` → 0.2.1
- `@mushi-mushi/plugin-sentry` → 0.2.10
- `@mushi-mushi/plugin-slack-app` → 0.2.7
- `@mushi-mushi/plugin-zapier` → 0.2.8
...
- `@mushi-mushi/inventory-auth-runner` → 0.1.3
- `@mushi-mushi/mcp` → 0.1.0
- `@mushi-mushi/plugin-bugsnag` → 0.1.5
- `@mushi-mushi/plugin-crashlytics` → 0.1.5
- `@mushi-mushi/plugin-discord` → 0.1.5
- `@mushi-mushi/plugin-github-issues` → 0.1.5
- `@mushi-mushi/plugin-msteams` → 0.1.5
- `@mushi-mushi/plugin-rollbar` → 0.1.5
