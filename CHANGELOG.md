...
- `@mushi-mushi/angular` → 0.8.0
- `@mushi-mushi/core` → 0.8.0
- `@mushi-mushi/react` → 0.8.0
- `@mushi-mushi/react-native` → 0.8.0
- `@mushi-mushi/svelte` → 0.8.0
- `@mushi-mushi/vue` → 0.8.0
...
- `@mushi-mushi/mcp` → 0.3.7
- `@mushi-mushi/node` → 0.3.4
