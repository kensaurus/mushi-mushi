...
- `@mushi-mushi/mcp-ci` → 0.6.4
- `@mushi-mushi/node` → 0.6.0
- `@mushi-mushi/plugin-cursor-cloud` → 0.6.1
- `@mushi-mushi/plugin-sdk` → 0.6.0
- `create-mushi-mushi` → 0.6.2
- `mushi-mushi` → 0.6.5
...
- `@mushi-mushi/inventory-schema` → 0.4.3
...
- `@mushi-mushi/plugin-linear` → 0.3.2
...
- `eslint-plugin-mushi-mushi` → 0.3.4
...
- `@mushi-mushi/plugin-jira` → 0.2.7
- `@mushi-mushi/plugin-linear` → 0.2.7
- `@mushi-mushi/plugin-pagerduty` → 0.2.9
- `@mushi-mushi/plugin-sdk` → 0.2.1
- `@mushi-mushi/plugin-sentry` → 0.2.11
- `@mushi-mushi/plugin-slack-app` → 0.2.8
- `@mushi-mushi/plugin-zapier` → 0.2.9
- `@mushi-mushi/react` → 0.2.1
- `@mushi-mushi/react-native` → 0.2.3
- `@mushi-mushi/svelte` → 0.2.3
- `@mushi-mushi/vue` → 0.2.3
- `@mushi-mushi/wasm-classifier` → 0.2.3
...
- `@mushi-mushi/inventory-auth-runner` → 0.1.4
- `@mushi-mushi/mcp` → 0.1.0
- `@mushi-mushi/plugin-bugsnag` → 0.1.6
- `@mushi-mushi/plugin-crashlytics` → 0.1.6
- `@mushi-mushi/plugin-discord` → 0.1.6
- `@mushi-mushi/plugin-github-issues` → 0.1.6
- `@mushi-mushi/plugin-msteams` → 0.1.6
- `@mushi-mushi/plugin-rollbar` → 0.1.6
