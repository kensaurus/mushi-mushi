/**
 * Smoke test for enhanced Intelligence page.
 */
...
test.describe('Intelligence enhanced shell', () => {
  test.skip(
  ...
  test('overview loads banner, KPI strip, and tabs', async ({ page }) => {
    ...
    await expect(page.getByLabel('Intelligence sections').getByRole('radio', { name: 'Overview' })).toBeChecked()
  })
